# BCN-CAP-01 - Expor GET /api/v1/capabilities canonical
...
`rewire-beacon` retornando a lista de capabilities deste service conforme
...
4. Webhook outbound apos deploy:
   - Executar `POST {aggregator}/aggregator/invalidate` body
     `{ "service": "rewire-beacon", "reason": "deploy" }`.
...
ver ticket complementar BCN-CAP-02.
